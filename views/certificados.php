    ...
    <div class="container-fluid">
        ...
        <div class="col-xs-12">
            <div class="buttons-row">
                <a class="btn btn-danger" href="../views/user.php">
                    <i class="bi bi-box-arrow-left" style="font-size: 25px; margin-right: 10px;"> Atras</i>
                </a>
                <a class="btn btn-success">
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregar">
                        <i class="bi bi-file-earmark-pdf" style="font-size: 18px; margin-left: 5px;"> Agregar Certificado</i>
                    </button>
                </a>
            </div>
